 ...
 * for the SSR pass, UV coordinates for texturing, and the light-space
 * clip position for shadow mapping.
 *
 * The SSR pass reconstructs view-space rays from depth, while the third MRT
 * target stores world_pos for debug display and per-surface reflectivity.
 *
...
VSOutput main(VSInput input)
{
    ...
    /* Transform normal to view space for the SSR G-buffer. */
