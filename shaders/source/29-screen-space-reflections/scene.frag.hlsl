 ...
 * direction. The world-space position target is used for debug display, and
 * its alpha channel carries per-surface reflectivity.
 *
...
struct PSOutput
{
    ...
    float4 world_pos   : SV_Target2;  /* world position + reflectivity */
};
              ...
              float4 light_clip : TEXCOORD4)
{
    ...
    /* ── World-space position and SSR reflectivity ─────────────────── */
