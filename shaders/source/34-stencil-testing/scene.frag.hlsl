 ...
 * color tint.  The tint is used to distinguish objects in the portal world
 * from objects in the normal world.
 *
...
cbuffer SceneFragUniforms : register(b0, space3)
{
    ...
    float2 _pad1;           /* strict cbuffer/WebGPU layout padding       */
    float3 tint;            /* additive color tint for portal world       */
    float  _pad0;
};
