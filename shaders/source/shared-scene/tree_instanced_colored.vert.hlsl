/*
 * tree_instanced_colored.vert.hlsl - Instanced tree mesh vertex shader with per-instance color
 *
 * Adapted from forge-gpu common/scene/shaders/scene_instanced_colored.vert.hlsl.
 * The SDL demo keeps it with the terrain/tree shader family while preserving
 * Forge's colored 80-byte instance stream.
 *
