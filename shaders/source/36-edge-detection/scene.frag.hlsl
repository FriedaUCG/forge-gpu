/*
 * Scene fragment shader — Blinn-Phong lighting with shadow map, MRT output.
 *
 * Renders lit scene color to Target0 and view-space normals to Target1.
...
PSOutput main(PSInput input)
{
    ...
    output.normal = float4(normalize(input.view_nrm), 1.0);
