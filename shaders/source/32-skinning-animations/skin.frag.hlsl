/*
 * Skinned fragment shader — Blinn-Phong with directional light and shadow map.
 *
 * Identical to the scene.frag.hlsl from Lesson 31 — the skinning is handled
 * entirely in the vertex shader.  Fragment shading only cares about
 * world-space positions and normals, which the vertex shader provides
 * after applying the skin matrix.
 *
