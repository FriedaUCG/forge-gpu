 ...
 * This is the RGBA8 texture we write the plasma result into each frame.
 * The SDL_shadercross generator passes the storage texture format policy when
 * producing WGSL and the matching SDL compute resource layout. */
